<template>
  <div class="h-full flex">
    <!-- Left Panel (unstaged + staged) and Right Panel (diff) with horizontal resizer -->
    <ResizablePanel direction="horizontal" :default-size="320" :min-size="250" :max-size="500">
      <template #first>
        <!-- Left: File Lists with vertical resizer between unstaged/staged -->
        <ResizablePanel direction="vertical" :default-size="300" :min-size="150" :max-size="800">
          <template #first>
            <!-- Top: Unstaged Section -->
            <div class="h-full flex flex-col border-b border-gray-700 overflow-hidden">
